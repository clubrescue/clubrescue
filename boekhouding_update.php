	...
	if(current_user_can('administrator') || current_user_can('administrator') || $user->user_login === 'D271RRP') {	
		...
		try{
			...
			if($database->endTransaction()){
				echo 'Update succesvol, klik <a href="boekhouding.php">hier</a> om terug te gaan.';
			}else{
				echo 'Update NIET succesvol, klik <a href="boekhouding.php">hier</a> om terug te gaan.';
			}	
