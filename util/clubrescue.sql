...
INSERT INTO `settings` VALUES (1, '2.4.1', 'users', '/home/pyasi/citrus_project/io','16:00:00','y','n','n','n','n','n','y','http://localhost/cancel', 'billing', 'shipping');
...
ALTER TABLE `billing` ADD INDEX  `account_number_index` (  `account_number` );
