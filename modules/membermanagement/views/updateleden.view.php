                    ...
                    <div class="col s12">
                        <table class="striped">
                            ...
                            <tr>
                                ...
                                <td><input name="Machtigingskenmerk" type="text" value="<?php echo $ledenGegevensResult["Machtigingskenmerk"]; ?>">
									<th>Ondertekend op</th>
								<td><input name="MachtigingOndertekend" type="date" value="<?php echo $ledenGegevensResult["MachtigingOndertekend"]; ?>"></td>
                            </tr>
                        </table>
                    </div>
                </div>
