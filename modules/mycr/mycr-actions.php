<?php
	...
	if(isset($user)){
		...
		$acties_wijzien .= '<br><a href="https://trb.nu/clubforms/view.php?id=18290&element_67='.$result[0]['Relatienr'].'&element_68='.$result[0]['VolledigeNaam'].'" target="_blank">Verenigingsdiplomas (Verklaring Eerste Hulp)</a>';
		$acties_wijzien .= '<br><a href="https://trb.nu/clubforms/view.php?id=17811&element_66='.$result[0]['Relatienr'].'&element_67='.$result[0]['VolledigeNaam'].'" target="_blank">Bondsdiplomas (Klein Vaarbewijs, Basiscertificaat Marifonie, VOG)</a>';
		$acties_wijzien .= '<br><a href="https://account.activedirectory.windowsazure.com/ChangePassword.aspx">Wachtwoord wijzigen</a>';
		...
		if( requiresPrivilege('priv_test_WPC') == true || requiresPrivilege('priv_test_WPE') == true || requiresPrivilege('priv_test_Admin') == true ) {
			$acties_strandbewaking .= '<br><a href="https://trb.nu/clubredders" target="_blank">Club.Redders voor ASC/809</a>';
		...
		// Declaratie opties voor het gehele kader
		if( requiresPrivilege('priv_test_WPC') == true || requiresPrivilege('priv_test_WPE') == true || requiresPrivilege('priv_test_Admin') == true ) {
		...
		// Registratie opties voor het bestuur
		...
		// Applicaties voor het gehele kader
		if( requiresPrivilege('priv_test_WPC') == true || requiresPrivilege('priv_test_WPE') == true || requiresPrivilege('priv_test_Admin') == true ) {
			// ITSuite4NP
			$acties_kader .= '<br><br><a href="https://trb.nu/clubredders" target="_blank">Club.Redders</a>';
			$acties_kader .= '<br><a href="https://www.office.com/" target="_blank">Office 365</a>';
			$acties_kader .= '<br><a href="https://trb.nu/clubforms/index.php" target="_blank">MachForm</a>';
			$acties_kader .= '<br><a href="https://trb.nu/wp-login.php?redirect_to=https://trb.nu" target="_blank">WordPress</a>';
			$acties_kader .= '<br><a href="https://trb.nu/clubkee" target="_blank">KeeWeb</a>';
				// Office 365 subapplicaties
				$acties_kader .= '<br><br><a href="https://outlook.office365.com/owa/?realm=trb.nu" target="_blank">Outlook</a>';
				$acties_kader .= '<br><a href="https://teams.microsoft.com/" target="_blank">Teams</a>';
				$acties_kader .= '<br><a href="https://texelsereddingsbrigade-my.sharepoint.com/_layouts/15/MySite.aspx?MySiteRedirect=AllDocuments" target="_blank">OneDrive</a>';
				$acties_kader .= '<br><a href="https://app.powerbi.com/?realm=trb.nu" target="_blank">Power BI</a>';
				// Office 365 beheer acties
				if( requiresPrivilege('priv_test_Admin') == true ) {
					$acties_kader .= '<br><a href="https://admin.microsoft.com/" target="_blank">Office 365 beheercentrum</a>';
					$acties_kader .= '<br><a href="https://admin.exchange.microsoft.com/" target="_blank">Exchange beheercentrum</a>';
					$acties_kader .= '<br><a href="https://portal.azure.com/" target="_blank">Azure beheercentrum</a>';
				}
			// Vrijwilligersovereenkomst
			$acties_kader .= '<br><br><a href="https://trb.nu/clubforms/view.php?id=22542&element_2='.$result[0]['Relatienr'].'&element_3='.$result[0]['VolledigeNaam'].'&element_15='.$result[0]['Email'].'&element_6='.$result[0]['Verenigingsfunctie'].'&element_4='.$result[0]['Woonplaats'].'"target="_blank">Vrijwilligersovereenkomst</a>';
		}
