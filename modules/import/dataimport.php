...
/*** Club.Redders - PAGE TEMPLATE TYPE - InternalDataMutations - v0.8.5
	...
	if(isset($_FILES['EDP-Leden'])){
		...
		if(empty($errors)==true){
			$target = $crbinRoot."/crbin/import/".$file_name;
			$target_backup = $crbinRoot."/crbin/backup/".$file_name_backup;
...
<div class="container">
	...
	<!--	GEEN DIPLOMA UPDATES ZOLANG DEZE EEN TABLE DROP DOET IPV DROP BONDSDIPLOMA'S EN ADD ENKEL BONDSDIPLOMA'S
			...
			ALLEEN ACTIVEREN INDIEN ISSUE GEFIXED IS -->
					<div class="file-field input-field">
						<div class="btn">
