<?php
	...
	/*** Declarations counter page for external formstool, currently based on MachForm design
...
#main_body h1 a
{
background-image: url('https://trb.nu/clubforms/images/logo-clubforms.png');
height: 80px;
}
