<?php
	...
	if(isset($_FILES['ExcelBewakingsTool'])){
		...
		if(empty($errors)==true){
			echo rename("/srv/home/trbnu/domains/trb.nu/crbin/excel/".$file_name,"/srv/home/trbnu/domains/trb.nu/crbin/backup/".$file_name_backup );
			move_uploaded_file($file_tmp,"/srv/home/trbnu/domains/trb.nu/crbin/excel/".$file_name);
	...
	*/
	if(isset($_FILES['ExcelInschrijvingsTool'])){
		...
		if(empty($errors)==true){
			rename("/srv/home/trbnu/domains/trb.nu/crbin/excel/".$file_name, "/srv/home/trbnu/domains/trb.nu/crbin/backup/".$file_name_backup);
			move_uploaded_file($file_tmp,"/srv/home/trbnu/domains/trb.nu/crbin/excel/".$file_name);
...
<div class="container">
		<div class="section">
			...
			<a href="/srv/home/trbnu/domains/trb.nu/crbin/excel/clubredders-edt.xlsb" download=<?php echo $_SERVER['HTTP_HOST'].".xlsb" ?>>Start de Excel Competenties support Tool</a> en download <a href="edp-sdem-csv-competenties-support-tool.php">het CSV bronbestand.</a><br>
			<a href="/srv/home/trbnu/domains/trb.nu/crbin/excel/clubredders-eft.xlsb" download=<?php echo $_SERVER['HTTP_HOST'].".xlsb" ?>>Start de Excel Boekhouding Tool</a> en download <a href="edp-sdem-csv-boekhouding-tool.php">het CSV bronbestand.</a><br>
			<a href="/srv/home/trbnu/domains/trb.nu/crbin/excel/clubredders-eit.xlsb" download=<?php echo $_SERVER['HTTP_HOST'].".xlsb" ?>>Start de Excel Jaarrooster Tool</a> en download <a href="edp-sdem-csv-jaarrooster-tool.php">het CSV bronbestand.</a><br>
			<!---// BEGIN stuff here for all editors and admins--->
			<?php if( current_user_can('editor') || current_user_can('administrator') ) {  ?>
				<a href="/srv/home/trbnu/domains/trb.nu/crbin/excel/clubredders-ept.xlsm" download="PAINTool.xlsm">Start de Excel Contributie Tool</a> en download <a href="edp-sdem-csv-contributie-tool.php">het CSV bronbestand.</a><br>
