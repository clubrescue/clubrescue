...
<!---// <body>--->
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4">Club.Redders (C.R) maakt op basis van externe ledenadministratie systemen data beschikbaar aan (kader)leden. C.R streeft een modulaire opbouw na waarmee nieuwe functionaliteiten eenvoudig toegevoegd kunnen worden. Dit is de 2de generatie van C.R. De 3de generatie<br>op basis van een modulair raamwerk is momenteel in ontwikkeling.</p>
  ...
  <script src="/clubredders/js/materialize.js"></script>
  <script src="/clubredders/js/init.js"></script>
